...
LOGGER.info("Starting Dion Robot...")
...
if ENV:
    ...
    from DionRobot.config import Development as Config
...
client = TelegramClient("DionRobot", api_id, api_hash)
...
from DionRobot.modules.helper_funcs.handlers import CustomCommandHandler
