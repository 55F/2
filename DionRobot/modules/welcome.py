...
import DionRobot.modules.sql.welcome_sql as sql
from DionRobot.modules.sql.global_bans_sql import is_user_gbanned
from DionRobot import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from DionRobot.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from DionRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from DionRobot.modules.helper_funcs.msg_types import get_welcome_type
from DionRobot.modules.helper_funcs.alternate import typing_action
from DionRobot.modules.helper_funcs.string_handling import (
    markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from DionRobot.modules.log_channel import loggable
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our channel: @DionSupport to know more about updates and tricks!".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Dion Robot have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
