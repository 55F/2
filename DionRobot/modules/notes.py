...
from DionRobot import dispatcher, MESSAGE_DUMP, LOGGER
from DionRobot.modules.disable import DisableAbleCommandHandler
from DionRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from DionRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from DionRobot.modules.helper_funcs.msg_types import get_note_type
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask in @DionSupport if you're unable to figure it out!"
            )
