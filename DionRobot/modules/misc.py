...
from DionRobot.__main__ import STATS, USER_INFO, GDPR
from DionRobot.modules.disable import DisableAbleCommandHandler
from DionRobot.modules.helper_funcs.extraction import extract_user
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Dion Robot data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](www.github.com/SeorangDion/DionRobot).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
