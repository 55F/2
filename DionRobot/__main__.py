...
from DionRobot.modules import ALL_MODULES
from DionRobot.modules.purge import client
from DionRobot.modules.helper_funcs.chat_status import is_user_admin
from DionRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DionRobot.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://telegra.ph/file/2ca2d2c973f6507379861.jpg",
                PM_START_TEXT,
